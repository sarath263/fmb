      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">" The greatest wealth is health "</h2>
            <p className="text-xl text-gray-400">Achieving a healthy weight is all about creating sustainable habits for a long-term lifestyle change.</p>
          </div>
